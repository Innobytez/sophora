(() => {
  ...
  const DICT = {
    es: {
      ...
      add_audio_link: "Agregar enlace",
      add_pdf_link: "Agregar enlace",
      add_video_link: "Agregar enlace",
      add_photo_link: "Agregar enlace",
      replace_link: "Cambiar enlace",
      remove_media: "Quitar",
      show_item: "Mostrar",
      ...
      audio_media_empty: "Todavia no hay audio.",
      technical_rider_empty: "Todavia no hay PDF.",
      ...
      onboarding_body_3: "Tambien puedes subir fotos, videos, audios y tu rider tecnico desde el dashboard.",
      dismiss: "Entendido",
    ...
    en: {
      ...
      add_audio_link: "Add link",
      add_pdf_link: "Add link",
      ...
      audio_media_empty: "No audio yet.",
      technical_rider_empty: "No PDF yet.",
      ...
      onboarding_body_3: "You can also upload photos, videos, audio, and your technical rider from the dashboard.",
      dismiss: "Understood",
